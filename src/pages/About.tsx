...
export default function AboutPage() {
  ...
  return (
    <main className="min-h-screen scroll-smooth" role="main" style={{ WebkitOverflowScrolling: 'touch' }}>
      <SEO
      ...
      <section className="relative py-24 md:py-32 bg-slate-50/40 will-change-scroll" aria-labelledby="credentials-heading">
                ...
                <div className="relative">
                  ...
                  <div className="relative bg-white p-4 rounded-3xl border border-slate-200 shadow-xl">
                    <img
                      ...
                      alt="Zachary Bradford, Licensed Insurance Broker - 8+ years helping families with health and life insurance"
                      width="500"
                      height="600"
            ...
            <Reveal delay={0.2}>
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <h2 id="credentials-heading" className="font-serif text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-6 text-slate-900">
                ...
                <div className="grid grid-cols-3 gap-3 md:gap-4 p-4 md:p-8 bg-white rounded-2xl border border-slate-200 shadow-lg">
                  <div className="text-center group">
                    <div className="text-xl md:text-2xl lg:text-3xl font-bold text-[hsl(157,72%,43%)] mb-1 md:mb-2 group-hover:scale-110 transition-transform duration-300">8+</div>
                    <div className="text-xs md:text-sm font-semibold text-slate-600 leading-tight">Years<br className="md:hidden" /> Experience</div>
                  </div>
                  <div className="text-center group">
                    <div className="text-xl md:text-2xl lg:text-3xl font-bold text-[hsl(224,100%,45%)] mb-1 md:mb-2 group-hover:scale-110 transition-transform duration-300">1,000+</div>
                    <div className="text-xs md:text-sm font-semibold text-slate-600 leading-tight">Clients<br className="md:hidden" /> Protected</div>
                  </div>
                  <div className="text-center group">
                    <div className="text-xl md:text-2xl lg:text-3xl font-bold text-[hsl(157,72%,43%)] mb-1 md:mb-2 group-hover:scale-110 transition-transform duration-300">6</div>
                    <div className="text-xs md:text-sm font-semibold text-slate-600 leading-tight">States<br className="md:hidden" /> Licensed</div>
                  </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  <Magnetic strength={12}>
                    <a
                      href={BRAND.phoneTel}
                      aria-label={`Call Bradford at ${BRAND.phoneHuman}`}
                      className="group relative inline-flex items-center justify-center gap-3 bg-gradient-to-r from-[hsl(157,72%,43%)] to-[hsl(157,72%,38%)] text-white px-8 py-4 rounded-2xl font-semibold text-base sm:text-lg shadow-lg hover:shadow-xl transition-all duration-500 transform hover:scale-[1.02] active:scale-[0.98] overflow-hidden min-h-[48px] touch-manipulation"
                    >
                  ...
                  <Magnetic strength={10}>
                    <a
                      ...
                      className="inline-flex items-center justify-center gap-3 bg-white border border-slate-300 text-slate-700 px-8 py-4 rounded-2xl font-semibold text-base sm:text-lg hover:bg-slate-50 hover:border-slate-400 transition-all duration-500 transform hover:scale-[1.02] active:scale-[0.98] min-h-[48px] touch-manipulation"
                    >
      ...
      <section className="py-24 md:py-32 bg-white" aria-labelledby="verification-heading">
        <div className="container mx-auto max-w-5xl px-6">
          <div className="rounded-3xl border border-emerald-200/70 bg-emerald-50/40 p-8 md:p-12 text-center shadow-sm">
            <h2 id="verification-heading" className="font-serif text-2xl md:text-3xl lg:text-4xl font-bold text-slate-900">
      ...
      <section className="relative py-24 md:py-32 overflow-hidden bg-[hsl(220,26%,14%)] will-change-scroll" aria-labelledby="story-heading">
        {/* Simplified Background Gradient */}
        <div className="absolute inset-0 bg-gradient-to-b from-[hsl(220,26%,14%)] via-[hsl(220,24%,12%)] to-[hsl(220,26%,14%)]"></div>

        {/* Subtle Ambient Glow */}
        <div className="absolute inset-0">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[400px] bg-[hsl(157,72%,43%)]/8 rounded-full blur-3xl"></div>
        </div>
        ...
        <div className="relative container mx-auto px-6 max-w-5xl z-10">
          <Reveal>
            <div className="text-center mb-16">
              ...
              <h2 id="story-heading" className="font-serif text-3xl md:text-4xl lg:text-5xl font-bold mb-6 leading-tight">
              ...
              <p className="text-lg md:text-xl font-sans text-white/90 leading-relaxed max-w-2xl mx-auto">
          ...
          <Reveal delay={0.2}>
            <div className="max-w-4xl mx-auto text-center space-y-8">
              <div className="space-y-6">
                <p className="text-base md:text-lg leading-relaxed text-white/90 font-sans">
                  Like most people, I once thought health insurance was just a necessary expense—something you paid monthly and hoped you'd never need. That changed in 2016 when a close friend's wife was diagnosed with an aggressive form of cancer at just 32 years old.
                </p>
                <p className="text-base md:text-lg leading-relaxed text-white/90 font-sans">
                  Their high-deductible plan seemed affordable until they faced the reality: $8,000 out-of-pocket before coverage kicked in, network restrictions that excluded the specialist she needed, and mounting treatment costs that forced them to choose between their home and her care. Watching them navigate this nightmare while grieving changed everything for me.
                </p>
                <p className="text-base md:text-lg leading-relaxed text-white/90 font-sans">
                  That's when I realized insurance isn't about premiums and deductibles—it's about ensuring families never have to choose between financial security and the care they desperately need. I became the advocate I wish they'd had: someone who reads the fine print, asks the hard questions, and ensures your coverage works when it matters most.
                </p>
              </div>
              ...
              <div className="group relative mt-12">
                ...
                <div className="relative p-8 md:p-12 rounded-2xl">
                  ...
                  <h3 className="font-serif text-xl md:text-2xl lg:text-3xl font-bold mb-6 bg-gradient-to-r from-[hsl(157,72%,43%)] to-[hsl(224,100%,32%)] bg-clip-text text-transparent">
                    My Family Protection Philosophy
                  </h3>

                  <blockquote className="text-lg md:text-xl lg:text-2xl font-serif italic text-white/95 leading-relaxed">
      ...
      <section className="relative py-24 md:py-32 bg-white will-change-scroll" aria-labelledby="credentials-process-heading">
        <div className="container mx-auto px-6 max-w-7xl">
          <Reveal>
            {/* Professional Header */}
            <div className="text-center mb-16">
              ...
              <h2 id="credentials-process-heading" className="font-serif text-3xl md:text-4xl lg:text-5xl font-bold mb-6 leading-tight text-slate-900">
              ...
              <p className="text-lg md:text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
                Verified expertise and <span className="text-slate-900 font-semibold">proven methodology</span> you can rely on
              </p>
            </div>
          </Reveal>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-20">
            <Reveal delay={0.1}>
              <Magnetic strength={8}>
                <div className="group p-6 md:p-10 bg-white rounded-3xl border border-slate-200 hover:border-[hsl(157,72%,43%)]/30 hover:shadow-xl transition-all duration-500 shadow-lg relative overflow-hidden">
            ...
            <Reveal delay={0.2}>
              <Magnetic strength={8}>
                <div className="group p-6 md:p-10 bg-white rounded-3xl border border-slate-200 hover:border-[hsl(224,100%,32%)]/30 hover:shadow-xl transition-all duration-500 shadow-lg relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-start gap-6">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-slate-600 leading-relaxed">Trusted by families across 6 states</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <Reveal delay={0.9}>
            <div className="bg-slate-50/60 p-8 md:p-16 rounded-3xl border border-slate-200/80 shadow-lg relative overflow-hidden">
              <div className="relative z-10">
                <h3 className="font-serif text-2xl md:text-3xl lg:text-4xl font-bold mb-12 text-center text-slate-900">How I Help You</h3>
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                  <div className="p-6 md:p-8 bg-white rounded-2xl border border-slate-200 hover:border-[hsl(157,72%,43%)]/40 hover:shadow-xl transition-all duration-500 group">
                  ...
                  <div className="p-6 md:p-8 bg-white rounded-2xl border border-slate-200 hover:border-[hsl(224,100%,32%)]/40 hover:shadow-xl transition-all duration-500 group">
      ...
      {/* PARTNERSHIP SECTION */}
      <section id="big-partnership" role="region" aria-labelledby="big-partnership-title" className="relative py-24 md:py-32 overflow-hidden bg-[hsl(220,26%,14%)] will-change-scroll">
        {/* Simplified Background Gradient */}
        <div className="absolute inset-0 bg-gradient-to-b from-[hsl(220,26%,14%)] via-[hsl(220,24%,12%)] to-[hsl(220,26%,14%)]"></div>

        {/* Subtle Ambient Glow */}
        <div className="absolute inset-0">
          <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[700px] h-[400px] bg-[hsl(157,72%,43%)]/10 rounded-full blur-3xl"></div>
        </div>
            ...
            <div className="bg-white/5 backdrop-blur-xl p-12 md:p-16 rounded-3xl border border-white/10 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="text-center mb-16">
                  ...
                  <h2 id="big-partnership-title" className="font-serif text-3xl md:text-4xl lg:text-5xl font-bold mb-6 leading-tight">
                    <span className="bg-gradient-to-r from-[hsl(157,72%,43%)] via-[hsl(157,72%,53%)] to-[hsl(224,100%,32%)] bg-clip-text text-transparent">
                      Trusted Health & Life Insurance Solutions
                    </span>
                  </h2>
                  <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto leading-relaxed font-normal">
                    5 years of trusted collaboration delivering
                    <span className="text-white font-semibold"> affordable, personal, transparent, and simple</span> insurance solutions with enterprise resources.
                  </p>
                </div>
                  ...
                  <div className="flex items-center gap-6">
                    <div className="relative">
                      <div className="w-28 h-28 bg-gradient-to-br from-[hsl(157,72%,43%)] to-[hsl(224,100%,32%)] rounded-3xl flex items-center justify-center shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] relative overflow-hidden">
                        ...
                        <span className="relative text-white font-bold text-3xl font-serif">BiG</span>
                      </div>
                ...
                <div className="grid md:grid-cols-2 gap-6 md:gap-8 mb-16">
                  <div className="group p-6 md:p-8 bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all duration-500 shadow-lg">
                    <div className="flex items-start gap-5">
                      ...
                      <div>
                        ...
                        <p className="text-white/85 leading-relaxed">Access to premium insurance carriers and specialized networks unavailable to independent agents.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="group p-6 md:p-8 bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all duration-500 shadow-lg">
                    <div className="flex items-start gap-5">
                      ...
                      <div>
                        ...
                        <p className="text-white/85 leading-relaxed">Backed by an established industry leader with nationwide presence and proven track record.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="group p-6 md:p-8 bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all duration-500 shadow-lg">
                    <div className="flex items-start gap-5">
                      ...
                      <div>
                        ...
                        <p className="text-white/85 leading-relaxed">United commitment to affordable, personal, transparent, and simple insurance solutions.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="group p-6 md:p-8 bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all duration-500 shadow-lg">
                    <div className="flex items-start gap-5">
                      ...
                      <div>
                        ...
                        <p className="text-white/85 leading-relaxed">Group purchasing power delivers better rates and enhanced coverage options for clients.</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-10 bg-gradient-to-r from-[hsl(157,72%,43%)]/10 to-[hsl(224,100%,32%)]/10 rounded-3xl border border-white/15 mb-16 backdrop-blur-sm">
                  <div className="text-center space-y-6">
                    <h3 className="font-serif text-2xl md:text-3xl font-bold text-white mb-6">The Perfect Partnership</h3>
                    <p className="text-base md:text-lg text-white/90 leading-relaxed max-w-4xl mx-auto">
                      Bradford Informed Guidance delivers <span className="font-semibold text-[hsl(224,100%,55%)]">Best Insurance Group's affordability, simplicity, and exclusive carrier access</span> with
                      <span className="font-semibold text-[hsl(157,72%,58%)]"> personalized local guidance you won't find at a call center.</span>
                    </p>
                    <p className="text-lg md:text-xl font-semibold text-[hsl(157,72%,53%)]">
                ...
                {/* Premium Timeline */}
                <div className="mb-16">
                  <h3 className="font-serif text-2xl md:text-3xl font-bold text-center text-white mb-12">Partnership Milestones</h3>
      ...
      <section className="relative py-24 md:py-32 bg-slate-50/40 will-change-scroll" aria-labelledby="why-choose-heading">
        <div className="container mx-auto px-6 max-w-6xl">
          <Reveal>
            ...
            <div className="text-center mb-16">
              ...
              <h2 id="why-choose-heading" className="font-serif text-3xl md:text-4xl lg:text-5xl font-bold mb-6 leading-tight text-slate-900">
                Why Families Choose
                <br />
                <span className="bg-gradient-to-r from-[hsl(157,72%,43%)] via-[hsl(157,72%,53%)] to-[hsl(224,100%,32%)] bg-clip-text text-transparent">
                  Bradford
              ...
              <p className="text-lg md:text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
                Personal service with <span className="text-slate-900 font-semibold">professional expertise</span>
              </p>
            </div>
          </Reveal>
                    ...
                    <div className="flex items-start gap-6">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-slate-600 leading-relaxed">
                          Born and raised in the communities I serve. I understand the unique challenges families face in Florida, Michigan, North Carolina, Arizona, Texas, and Georgia because I live them too.
                        </p>
                      </div>
                    </div>
                  </div>
      ...
      {/* CTA SECTION */}
      <section className="relative py-24 md:py-32 overflow-hidden bg-[hsl(220,26%,14%)] will-change-scroll" aria-labelledby="cta-heading">
        {/* Simplified Background Gradient */}
        <div className="absolute inset-0 bg-gradient-to-b from-[hsl(220,26%,14%)] via-[hsl(220,24%,12%)] to-[hsl(220,26%,14%)]"></div>

        {/* Subtle Ambient Glow */}
        <div className="absolute inset-0">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-[hsl(157,72%,43%)]/10 rounded-full blur-3xl"></div>
        </div>
        ...
        <div className="relative container mx-auto px-6 max-w-6xl z-10">
          <div className="text-center">
            <Reveal>
              {/* Luxury Typography */}
              <div className="mb-16">
                <h2 id="cta-heading" className="font-serif text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-8 leading-tight tracking-tight">
                ...
                <p className="text-lg md:text-xl text-white/90 max-w-4xl mx-auto leading-relaxed font-normal">
                  ...
                  <span className="text-white font-semibold"> you can trust.</span>
                </p>
              </div>
              
              {/* Premium CTA Buttons */}
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-stretch sm:items-center mb-20 px-4">
                <Magnetic strength={15}>
                  <a
                    href={BRAND.phoneTel}
                    aria-label={`Call Bradford at ${BRAND.phoneHuman} for consultation`}
                    className="group relative inline-flex items-center justify-center gap-4 bg-gradient-to-r from-[hsl(157,72%,43%)] to-[hsl(157,72%,38%)] text-white px-8 sm:px-12 py-5 sm:py-6 rounded-2xl font-semibold text-base sm:text-lg shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] hover:shadow-[0_0_20px_rgba(34,197,94,0.3)] transition-all duration-500 transform hover:scale-[1.02] active:scale-[0.98] overflow-hidden w-full sm:w-auto sm:min-w-[280px] min-h-[56px] touch-manipulation"
                  >
                    <div className="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                ...
                <Magnetic strength={12}>
                  <a
                    href={`mailto:${BRAND.email}`}
                    aria-label={`Email Bradford at ${BRAND.email}`}
                    className="group relative inline-flex items-center justify-center gap-4 bg-white/10 backdrop-blur-md border border-white/20 text-white px-8 sm:px-12 py-5 sm:py-6 rounded-2xl font-semibold text-base sm:text-lg hover:bg-white/20 hover:border-white/30 transition-all duration-500 transform hover:scale-[1.02] active:scale-[0.98] w-full sm:w-auto sm:min-w-[280px] min-h-[56px] touch-manipulation"
                  >
                ...
                <Magnetic strength={12}>
                  <a
                    href="/lead"
                    aria-label="Schedule a consultation with Bradford"
                    className="group relative inline-flex items-center justify-center gap-4 bg-white/5 backdrop-blur-md border border-white/15 text-white px-8 sm:px-12 py-5 sm:py-6 rounded-2xl font-semibold text-base sm:text-lg hover:bg-white/15 hover:border-white/25 transition-all duration-500 transform hover:scale-[1.02] active:scale-[0.98] w-full sm:w-auto sm:min-w-[280px] min-h-[56px] touch-manipulation"
                  >
                ...
                <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-10 md:p-12 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)]">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center justify-center gap-4 mb-6">
                      ...
                      <h3 className="font-serif text-xl md:text-2xl lg:text-3xl font-bold text-white">
                    ...
                    <p className="text-base md:text-lg text-white/90 leading-relaxed max-w-2xl mx-auto">
                      ...
                      <span className="text-[hsl(157,72%,53%)] font-semibold"> the best decision for your family.</span>
                    </p>
