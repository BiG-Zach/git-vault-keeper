...
export default function TermVsWholeLifeInsurance2024() {
  ...
  const articleSEO = buildArticleSEO({
    ...
    video: {
      name: 'Demystifying Life Insurance: Term vs Whole Life',
      description: 'Animated cost comparisons, data visualizations, and key statistics from LIMRA/Bankrate 2025 research.',
      thumbnailUrl: '/images/hero/resources-hero-retina.webp', // Using hero image as thumbnail
      uploadDate: datePublished,
      contentUrl: '/Demystifying_Life_Insurance.mp4',
