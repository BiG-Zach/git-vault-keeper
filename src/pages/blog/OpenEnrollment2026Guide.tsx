...
import { Clock, User, Calendar, Share2, ArrowLeft, CheckCircle, AlertTriangle, Shield } from 'lucide-react';
...
export default function OpenEnrollment2026Guide() {
  ...
  const articleSEO = buildArticleSEO({
    ...
    video: {
      name: 'Open Enrollment 2026: Avoiding Health Insurance Traps',
      description: 'Video overview with visual emphasis on key Open Enrollment 2026 statistics and deadlines',
      thumbnailUrl: '/images/hero/resources-hero-retina.webp', // Using hero image as thumbnail
      uploadDate: datePublished, // Using article publish date
      contentUrl: '/Open_Enrollment_2026_Avoiding_Health_Insurance_Traps.mp4',
      duration: 'PT8M', // 8 minutes in ISO 8601
    },
  });
        ...
        <SEO
          ...
          scripts={[
            ...
            { innerHTML: breadcrumbSchema([
              ...
              { name: title, item: `https://bradfordinformedguidance.com${path}` },
            ]) },
          ]}
        />
