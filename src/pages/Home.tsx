...
import { organizationSchema, serviceSchema, websiteSchema, breadcrumbSchema } from "../utils/schema";
...
export default function Home() {
  const structuredData = [
    ...
    breadcrumbSchema([{ name: 'Home', item: 'https://bradfordinformedguidance.com/' }]),
  ];
