...
import { HeartPulse, Clock3, Shield, DollarSign, PlayCircle, X } from 'lucide-react';
...
export default function HealthInsurance() {
  ...
  const structuredData = [
    ...
    breadcrumbSchema([
      ...
      { name: 'Health Insurance', item: 'https://bradfordinformedguidance.com/health-insurance' },
    ]),
  ];
