...
export const stateMetadata: Record<StateCodeSlug, StateMetaEntry> = {
  ...
  sc: {
    ...
    available: true,
    seo: {
      title: 'South Carolina Health & Life Insurance Broker | Bradford Informed Guidance',
      description: 'Licensed South Carolina health & life insurance broker. Expert guidance on health plans, life insurance options, and personalized coverage recommendations.',
      keywords: kw(['South Carolina health insurance broker', 'SC insurance agent', 'licensed insurance advisor', 'health insurance guidance', 'life insurance quotes', 'Columbia SC insurance']),
    },
  },
  sd: {
    name: 'South Dakota',
