  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto px-6 text-center bg-black/60 p-10 rounded-xl">
        ...
        <p className="text-lg">
          Independent insurance brokerage serving FL, MI, NC, AZ, TX, GA, and IN. Licensed professionals specializing in health and life insurance solutions with A-rated carrier partnerships.
        </p>
      </div>
    </section>
  );
