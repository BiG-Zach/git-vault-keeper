            ...
            <div className="space-y-8 lg:space-y-10">
              ...
              >
                <p className="text-lg lg:text-xl font-luxury-sans text-white/90 leading-relaxed max-w-2xl lg:max-w-xl antialiased">
                  Partnering with Best Insurance Group since 2020 to deliver exclusive carrier access and enterprise resources with personal, local guidance. Serving families in FL, MI, NC, AZ, TX, GA, and IN with transparent recommendations and no-pressure consultations.
                </p>
