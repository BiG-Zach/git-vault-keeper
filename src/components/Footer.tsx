      ...
      <div className="container mx-auto max-w-screen-2xl px-4 md:px-6 lg:px-8 py-8 md:py-10">
        <div className={`grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8 ${footerMobile.mobileColumnsToStack}`}>
          ...
          >
            ...
            <nav className="space-y-2">
              <Link to="/states/fl" className="block text-slate-300 hover:text-white transition-colors duration-200 text-sm">
                Florida
              </Link>
              <Link to="/states/mi" className="block text-slate-300 hover:text-white transition-colors duration-200 text-sm">
                Michigan
              </Link>
              <Link to="/states/nc" className="block text-slate-300 hover:text-white transition-colors duration-200 text-sm">
                North Carolina
              </Link>
              <Link to="/states/az" className="block text-slate-300 hover:text-white transition-colors duration-200 text-sm">
                Arizona
              </Link>
              <Link to="/states/tx" className="block text-slate-300 hover:text-white transition-colors duration-200 text-sm">
                Texas
              </Link>
              <Link to="/states/ga" className="block text-slate-300 hover:text-white transition-colors duration-200 text-sm">
                Georgia
              </Link>
              <Link to="/states/in" className="block text-slate-300 hover:text-white transition-colors duration-200 text-sm">
                Indiana
              </Link>
              <Link to="/states/sc" className="block text-slate-300 hover:text-white transition-colors duration-200 text-sm">
                South Carolina
              </Link>
              <span className="block text-slate-400 text-sm">
                Now serving eight licensed states
              </span>
            </nav>
          </motion.div>
