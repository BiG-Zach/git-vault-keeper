...
export default function RingyLeadCaptureForm({ className }: RingyLeadCaptureFormProps) {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (import.meta.env.DEV) {
      console.warn('Form submit - hCaptchaToken:', formData.hcaptchaToken);
      console.warn('Form submit - isCaptchaVerified:', isCaptchaVerified);
      console.warn('Form submit - formData:', formData);
      console.warn('Form submit - formData.hcaptchaToken:', formData.hcaptchaToken);
    }
