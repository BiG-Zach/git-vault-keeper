...
async function main() {
  ...
  // Changed to 'patch' to update the existing document
  const mutations = [
    {
      patch: {
        id: 'florida-2026-health-insurance-crisis',
        set: {
          title: 'Florida 2026 Health Insurance Crisis: 3 Ways to Cut Your Premium Now',
          slug: { _type: 'slug', current: 'florida-2026-health-insurance-crisis' },
          status: 'published',
          contentTrack: 'health-insurance',
          publishedAt: '2026-04-15T00:00:00Z',
          seo: {
            metaTitle: 'Florida 2026 Health Insurance Crisis: 3 Ways to Cut Your Premium Now',
